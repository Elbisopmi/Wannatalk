...
public class LongLexTo {
  ...
  public LongLexTo() throws IOException {
    ...
    dict=new Trie();
    File dictFile=new File("C:\\Users\\narongsak.mala\\Documents\\SourceCode\\program-ab\\src\\longlexto\\lexitron.txt");
    if(dictFile.exists())
      addDict(dictFile);
    else
  ...
  public static void main(String[] args) throws IOException {
    ...
    File unknownFile=new File("C:\\\\\\\\Users\\\\\\\\narongsak.mala\\\\\\\\Documents\\\\\\\\SourceCode\\\\\\\\program-ab\\\\\\\\src\\\\\\\\longlexto\\\\\\\\lexitron.txt");
    ...
    do {      
      ...
      do {
        ...
        if(inFileName.equals("q"))
          System.exit(1);
        inFile=new File("C:\\test\\a.txt");//new File(System.getProperty("user.dir") + "//" + inFileName);
        break;
      ...
      outFile=new File("C:\\test\\a.html");//new File(System.getProperty("user.dir") + "//" + outFileName);
