...
public class Bot {
    ...
    public String root_path = "C:\\Users\\narongsak.mala\\Documents\\SourceCode\\wannatalk";
                ...
                for (File listOfFile : listOfFiles) {
                    if (listOfFile.isFile()) {
                        ...
                        if (file.endsWith(".aiml") || file.endsWith(".AIML")) {
                            ...
                            try {
                                ArrayList<Category> moreCategories = AIMLProcessor.AIMLToCategories(aiml_path, file, this.tokenizer);
