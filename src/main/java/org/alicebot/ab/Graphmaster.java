...
public class Graphmaster {
    ...
    public void addCategory (Category category) {
        ...
        //System.out.println("inputThatTopic after replace bot properties: "+inputThatTopic);
    ...
    void printgraph(Nodemapper node, String partial) {
        if (node == null) System.out.println("Null graph");
            ...
            if (NodemapperOperator.isLeaf(node) || node.shortCut) {
                ...
                if (node.shortCut) System.out.println("ShortCut: "+partial+"("+NodemapperOperator.size(node)+"["+node.height+"])--<THAT>-->X(1)--*-->X(1)--<TOPIC>-->X(1)--*-->"+template+"...");
